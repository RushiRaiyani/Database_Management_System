...
SELECT REGION,SUM(SALES_AMOUNT) FROM SALES_DATA GROUP BY REGION ORDER BY SUM(SALES_AMOUNT) 
--Part – B:
...
SELECT REGION,PRODUCT FROM SALES_DATA GROUP BY PRODUCT,REGION HAVING COUNT(PRODUCT)>1 
