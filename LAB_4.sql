...
DELETE FROM DEPOSIT_DETAIL WHERE BNAME='CAHNDI'
...
--PART-B-DELETE,TRUNCATE,DROP OPERATION
...
INSERT INTO EMPLOYEE_MASTER VALUES(101,'KEYUR','2002-01-05',120000,'RAJKOT'),(102,'HARDIK','2004-02-15',140000,'AHEMDABD'),
(103,'KAJAL','2006-03-14',150000,'BARODA'),(104,'BHOOMI','2005-06-23',12500,'AHMEDABAD'),(105,'HARMIT','2004-02-15',140000,'RAJKOT'),
(106,'MITESH','2001-09-25',5000,'JAMNAGAR'),(107,'MEERA',NULL,7000,'MORBI'),(108,'KISHAN','2003-02-06',1000,NULL);
