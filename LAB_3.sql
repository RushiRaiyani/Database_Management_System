...
SELECT*FROM CRICKET
--PART-A-1. Create table Worldcup from cricket with all the columns and data.
...
--PART-A-UPDATE-1. Update deposit amount of all customers from 3000 to 5000. (Use Deposit Table)
...
UPDATE DEPOSIT SET ADATE =  NULL ,BNAME='ANDHERI' WHERE ACOUNTNO=110